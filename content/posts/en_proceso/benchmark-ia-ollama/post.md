...
El informe completo, con todas las tablas y el detalle de metodología, está disponible en [`informe-benchmarking-ia-ollama-v1.md`](assets/informe-benchmarking-ia-ollama-v1.md).
